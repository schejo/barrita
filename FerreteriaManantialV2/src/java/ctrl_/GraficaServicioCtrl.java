...
import org.ngi.zhighcharts.ZHighCharts;
  ...
  public class GraficaServicioCtrl extends GenericForwardComposer {
   ...
   // private Datebox Fecha_Final;
    ...
    public void Grafica1(String Fecha_inicial) throws SQLException{
        GraficaServicioDal dataBase = new GraficaServicioDal();
        ...
        List<GraficaServicioMd> data = dataBase.Grafica1(Fecha_inicial);
        String categoria = "";

        int i = 0;    
        
        for (GraficaServicioMd valor : data) {
            if (categoria.equals("")) {
    ...
    public void Grafica2(String fecha_inicial) throws SQLException {
        ...
        grafica2.setTitle("PORCENTAJE DE PRODUCTOS POR CATEGORIA");
